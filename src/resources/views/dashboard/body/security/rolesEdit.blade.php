    ...
    <div class="container-fluid py-2">
        <div class="row">
            <div class="col-12 text-center">
                <h4 class="mt-5 font-weight-bolder h4">{{ __('message.EditRoleTitle') }}</h4>
                <h5 class="font-weight-normal text-md opacity-6">{{__('message.EditRoleSubTitle')}}</h5>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="multisteps-form__form" style="height: 372px;" method="post"
                                          action="{{ route('security.roles.update.store', ['id' => $role->id]) }}">
                                        @method('POST')
                                        @csrf
                                        <!--single form panel-->
                                                                    ...
                                                                    <td class="d-flex justify-content-center align-items-center">
                                                                        <div
                                                                            ...
                                                                            <input class="form-check-input"
                                                                                   type="checkbox"
                                                                                   name="perm[{{ $permission->id }}]" {{ ($role->hasPermissionTo($permission->name) ? 'checked' : '') }}>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                ...
                                                <div class="multisteps-form__content">
                                                    ...
                                                    <div class="button-row d-flex mt-4">
                                                        ...
                                                        <button class="btn bg-gradient-dark ms-auto mb-0" type="submit"
                                                                title="Send"> {{ __('message.RoleUpdate') }}
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
