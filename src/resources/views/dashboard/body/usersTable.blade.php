                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">{{ __('message.UsersTable') }}</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{ !empty($user->getRoleNames()) ? implode(',', $user->getRoleNames()->toArray()) : 'Non'}}
                            ...
                            @else
                                <div class="mx-3">
                                    <span> {{ __('message.UsersNotFound') }} </span>
                                </div>
                            @endif
